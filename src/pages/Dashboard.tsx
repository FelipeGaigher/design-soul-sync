...
import { Coins, Box, GitBranch, TrendingUp, ArrowRight, Sparkles, PlusCircle } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Conecte seus Design Systems e comece a sincronizar
            </p>
          </div>
          <Button
            size="lg"
            className="gap-2"
            onClick={() => navigate('/add-figma')}
          >
